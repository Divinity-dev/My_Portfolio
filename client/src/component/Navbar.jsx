    ...
    <div className='bg-transparent sticky top-0 z-10'>
     ...
     <nav className='flex justify-between items-center p-4 md:py-2 md:px-10 text-white '>
      ...
      {toggle &&(
        ...
        <li onClick={()=>{setToggle(prev=>!prev)}}>About</li>
          <li className='px-4 py-2 border-2 border-white' onClick={()=>{setToggle(prev=>!prev)}}>projects</li>
          <li onClick={()=>{setToggle(prev=>!prev)}}>testimonials</li>
          <li onClick={()=>{setToggle(prev=>!prev)}}>Contact me</li>
        </ul> 
      )}
